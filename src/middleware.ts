...
export const onRequest = defineMiddleware(async (context, next) => {
	...
	// Covers: Google Fonts, Google Analytics, Google Tag Manager, Sanity CMS, Sentry, Resend, Google Drive, social embeds, OpenPanel, Cloudflare Insights, Ahrefs
	// Google CSP recommendations: https://developers.google.com/tag-platform/security/guides/csp
	headers.set(
		'Content-Security-Policy',
		"default-src 'self'; " +
			"script-src 'self' 'unsafe-inline' https://*.sentry.io https://openpanel.dev https://static.cloudflareinsights.com https://www.googletagmanager.com https://*.googletagmanager.com https://www.google-analytics.com https://*.google-analytics.com https://www.google.com https://*.google.com https://analytics.ahrefs.com; " +
			"style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; " +
			"font-src 'self' https://fonts.gstatic.com https://fonts.googleapis.com; " +
			"img-src 'self' data: blob: https://cdn.sanity.io https://images.unsplash.com https://unsplash.com https://amalshalih.or.id https://facebook.com https://instagram.com https://youtube.com https://tiktok.com https://wa.me https://www.google.com/maps https://linktr.ee https://www.googleapis.com https://www.google-analytics.com https://*.google-analytics.com https://www.googletagmanager.com https://*.googletagmanager.com https://stats.g.doubleclick.net https://www.google.com https://*.google.com https://analytics.ahrefs.com; " +
